...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        admin_email = os.getenv('BOOTSTRAP_ADMIN_EMAIL', '') or 'admin@stylesathi.com'
        admin_password = os.getenv('BOOTSTRAP_ADMIN_PASSWORD', '') or 'StyleSathiAdmin!2025'
        if admin_run:
        ...
        seller_email = os.getenv('SELLER_SEED_EMAIL', '') or 'seller@stylesathi.com'
        seller_password = os.getenv('SELLER_SEED_PASSWORD', '') or 'seller123'
        if seller_run:
        ...
        customer_email = os.getenv('CUSTOMER_SEED_EMAIL', '') or 'customer@stylesathi.com'
        customer_password = os.getenv('CUSTOMER_SEED_PASSWORD', '') or 'customer123'
        if customer_run:
