...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'title', 'price', 'original_price', 'category', 'category_name', 'category_id', 'brand', 'description', 'image_url', 'image', 'model_glb', 'model_glb_url', 'sketchfab_embed_url', 'in_stock', 'rating', 'features', 'owner', 'sku', 'stock']
